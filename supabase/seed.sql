...
values
  ...
  ('Linen Throw Blanket', 'linen-throw-blanket',
   ...
   79.00, 'KES', (select id from public.categories where slug = 'home-living'),
  ...
  ('Ceramic Pour-Over Set', 'ceramic-pour-over-set',
   ...
   54.00, 'KES', (select id from public.categories where slug = 'home-living'),
  ...
  ('Merino Crew Sweater', 'merino-crew-sweater',
   ...
   119.00, 'KES', (select id from public.categories where slug = 'apparel'),
